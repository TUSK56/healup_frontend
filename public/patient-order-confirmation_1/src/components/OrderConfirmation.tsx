    ...
    <div className="min-h-screen bg-[#F8FAFC] rtl font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
          <button className="flex items-center justify-center gap-2 bg-[#0456AE] text-white py-4 rounded-2xl font-bold hover:opacity-90 transition-all shadow-lg shadow-blue-100">
            <MapPin className="w-5 h-5" />
            <span>تتبع الطلب</span>
          </button>
          <button className="flex items-center justify-center gap-2 bg-white text-[#0456AE] border-2 border-[#0456AE] py-4 rounded-2xl font-bold hover:bg-blue-50 transition-all">
