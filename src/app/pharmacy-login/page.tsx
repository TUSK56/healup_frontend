        ...
        >
          <div style={{ padding: "20px 20px 0 20px" }}>
            <div style={{ width: "100%", height: 180, borderRadius: 12, overflow: "hidden", position: "relative", background: "#b8d4e8" }}>
              <img src="/images/pharmacy_login.png" alt={t("auth.pharmacyLogin.imageAlt")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </div>

          <div style={{ padding: "30px 36px 34px" }}>
            <div style={{ textAlign: "center", marginBottom: 26 }}>
              <h1 style={{ fontSize: 26, fontWeight: 900, color: "#1a2e4a", marginBottom: 7 }}>{t("auth.pharmacyLogin.title")}</h1>
            ...
            <div style={{ marginBottom: 18 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8, flexDirection: dir === "rtl" ? "row-reverse" : "row" }}>
                ...
                <a href="/pharmacy-forgot-password" style={{ fontSize: 12.5, fontWeight: 600, color: "#2356c8", textDecoration: "none", cursor: "pointer" }}>
            ...
            {error ? (
              <div style={{ marginBottom: 14, fontSize: 13, fontWeight: 600, color: "#b91c1c", textAlign: ta }}>{error}</div>
            ) : null}
