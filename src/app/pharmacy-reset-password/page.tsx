          ...
          <div style={{ marginBottom: 18, textAlign: 'right' }}>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              <input
                ...
                style={{ width: '100%', padding: '14px 16px 14px 46px', border: '1.5px solid #dde3ed', borderRadius: 10, fontFamily: 'Cairo, sans-serif', fontSize: 14, color: '#1a2e4a', background: '#fff', outline: 'none', textAlign: 'right', direction: 'rtl' }}
              />
