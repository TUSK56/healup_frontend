          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-16">
              ...
              <nav className="hidden md:flex items-center gap-8">
                <a href="#" className="text-gray-400 hover:text-[#0052CC] font-bold transition-colors">الرئيسية</a>
                <a href="#" className="text-[#0052CC] font-extrabold relative py-2">
                  طلباتي
                  <span className="absolute bottom-0 left-0 right-0 h-1 bg-[#0052CC] rounded-full"></span>
                </a>
                <a href="#" className="text-gray-400 hover:text-[#0052CC] font-bold transition-colors">الملف الشخصي</a>
              </nav>
            </div>
                ...
                <div className="flex-1 space-y-6 text-right">
                  ...
                  <div className="flex flex-row gap-3 pt-2">
                    {order.status === 'processing' && (
                      <button className="px-10 bg-[#0052CC] text-white py-3 rounded-xl font-black text-sm hover:bg-[#0041a3] transition-all">
                        تتبع الطلب
                      </button>
                    )}
                    <button className="px-10 bg-white border border-gray-200 text-gray-600 py-3 rounded-xl font-black text-sm hover:bg-gray-50 transition-all">
                      تفاصيل الطلب
                    </button>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-16 mb-20">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-2xl font-black text-[#002B5B]">Healup</span>
              </div>
